...
\definecolor{metadata}{HTML}{555555}
\definecolor{listingbg}{HTML}{F7F7F7}
\definecolor{listingrule}{HTML}{D8D8D8}
...
\pagestyle{fancy}
\fancyhf{}
\lhead{MathForge SLM evaluation outputs}
\rhead{\thepage}
\renewcommand{\headrulewidth}{0.3pt}
\title{MathForge SLM: Generated Problems and Solutions}
\author{Model: \texttt{Qwen/Qwen2.5-Math-7B-Instruct}}
\date{}
\begin{document}
\maketitle
\section*{Contents}
...
\textbf{Important:} These are the model's unedited evaluation outputs.
Malformed mathematics, repeated text, formatting failures, and truncation
are intentionally preserved. Literal typesetting ensures the document
compiles without silently repairing the generations.
\end{minipage}}
\clearpage
\section{alg-finite-interp --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 1 of 24\quad
\textbf{Topic:} Algebra\\[2pt]
\textbf{Required techniques:} Finite Differences, Lagrange Interpolation\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}

\subsection*{Generated problem, answer, and solution}
...
\end{lstlisting}
\clearpage
\section{alg-finite-interp --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 2 of 24\quad
\textbf{Topic:} Algebra\\[2pt]
\textbf{Required techniques:} Finite Differences, Lagrange Interpolation\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{alg-roots-symmetry --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 3 of 24\quad
\textbf{Topic:} Algebra\\[2pt]
\textbf{Required techniques:} Roots of Unity Filter, Symmetric Polynomial Reduction\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{alg-roots-symmetry --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 4 of 24\quad
\textbf{Topic:} Algebra\\[2pt]
\textbf{Required techniques:} Roots of Unity Filter, Symmetric Polynomial Reduction\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{nt-valuation-factorial --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 5 of 24\quad
\textbf{Topic:} Number Theory\\[2pt]
\textbf{Required techniques:} p-adic Valuation Bookkeeping, Legendre's Formula\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{nt-valuation-factorial --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 6 of 24\quad
\textbf{Topic:} Number Theory\\[2pt]
\textbf{Required techniques:} p-adic Valuation Bookkeeping, Legendre's Formula\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{nt-recurrence-gcd --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 7 of 24\quad
\textbf{Topic:} Number Theory\\[2pt]
\textbf{Required techniques:} gcd of Sequence Terms, Multiplicative Order\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{nt-recurrence-gcd --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 8 of 24\quad
\textbf{Topic:} Number Theory\\[2pt]
\textbf{Required techniques:} gcd of Sequence Terms, Multiplicative Order\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{co-double-pigeonhole --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 9 of 24\quad
\textbf{Topic:} Combinatorics\\[2pt]
\textbf{Required techniques:} Double Counting, Pigeonhole Principle\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{co-double-pigeonhole --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 10 of 24\quad
\textbf{Topic:} Combinatorics\\[2pt]
\textbf{Required techniques:} Double Counting, Pigeonhole Principle\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{co-invariant-expectation --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 11 of 24\quad
\textbf{Topic:} Combinatorics\\[2pt]
\textbf{Required techniques:} Invariant, Linearity of Expectation\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{co-invariant-expectation --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 12 of 24\quad
\textbf{Topic:} Combinatorics\\[2pt]
\textbf{Required techniques:} Invariant, Linearity of Expectation\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{geo-inversion-power --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 13 of 24\quad
\textbf{Topic:} Geometry\\[2pt]
\textbf{Required techniques:} Inversion, Power of a Point\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{geo-inversion-power --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 14 of 24\quad
\textbf{Topic:} Geometry\\[2pt]
\textbf{Required techniques:} Inversion, Power of a Point\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{geo-reflection-area --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 15 of 24\quad
\textbf{Topic:} Geometry\\[2pt]
\textbf{Required techniques:} Reflection Technique, Area Ratio Method\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{geo-reflection-area --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 16 of 24\quad
\textbf{Topic:} Geometry\\[2pt]
\textbf{Required techniques:} Reflection Technique, Area Ratio Method\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{prob-first-linearity --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 17 of 24\quad
\textbf{Topic:} Probability\\[2pt]
\textbf{Required techniques:} First-Step Analysis, Linearity of Expectation\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{prob-first-linearity --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 18 of 24\quad
\textbf{Topic:} Probability\\[2pt]
\textbf{Required techniques:} First-Step Analysis, Linearity of Expectation\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{ineq-smoothing-tangent --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 19 of 24\quad
\textbf{Topic:} Inequalities\\[2pt]
\textbf{Required techniques:} Smoothing / Adjustment, Tangent Line Trick\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{ineq-smoothing-tangent --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 20 of 24\quad
\textbf{Topic:} Inequalities\\[2pt]
\textbf{Required techniques:} Smoothing / Adjustment, Tangent Line Trick\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{nt-roots-residues --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 21 of 24\quad
\textbf{Topic:} Number Theory\\[2pt]
\textbf{Required techniques:} Roots of Unity Filter, Pigeonhole on Residues\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{nt-roots-residues --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 22 of 24\quad
\textbf{Topic:} Number Theory\\[2pt]
\textbf{Required techniques:} Roots of Unity Filter, Pigeonhole on Residues\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{alg-invariant-telescope --- repetition 1}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 23 of 24\quad
\textbf{Topic:} Algebra\\[2pt]
\textbf{Required techniques:} Invariant / Monovariant, Telescoping Products\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
...
\end{lstlisting}
\clearpage
\section{alg-invariant-telescope --- repetition 2}
\begin{minipage}{\textwidth}
\color{metadata}\small\raggedright
\textbf{Entry:} 24 of 24\quad
\textbf{Topic:} Algebra\\[2pt]
\textbf{Required techniques:} Invariant / Monovariant, Telescoping Products\\[2pt]
\textbf{Strict format pass:} False
\end{minipage}
